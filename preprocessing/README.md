...
### [`register_transcript.py`](transcript/register_transcript.py)
...
### [`register_segment_initial.py`](segmentation/register_segment_initial.py) 
...
### [`register_segment_refine.py`](segmentation/register_segment_refine.py)  
...
### [`segment_attributes.py`](segmentation/segment_attributes.py)  
...
### [`register_movement.py`](video/workspace/register_movement.py)  
...
### [`register_heatmaps_gaze.py`](video/workspace/register_heatmaps_gaze.py)  
...
### [`register_heatmaps_move.py`](video/workspace/register_heatmaps_move.py)  
...
### [`register_attention.py`](gaze/register_attention.py)  
...
### [`register_notes.py`](notes/register_notes.py)
